        ...
        <div className='p-5'>
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className='flex flex-col justify-center items-center'>
                    <h2 className='text-5xl uppercase font-bold'>Discover culinary adventures with <span className='text-[#7E90FE]'>Dish Diary</span> <br />your go-to source for delicious dishes.</h2>
